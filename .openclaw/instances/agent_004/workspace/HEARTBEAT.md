...
優先観点:
- unanswered questions, loose ends, and the next clean handoff
- pod `openclaw-4-pod`
...
2. まず `exec` で `python3 /home/node/.openclaw/mattermost-tools/mattermost_get_state.py --instance 4` を実行し、今の Mattermost 状態を確認する。
