...
優先観点:
- claims that need evidence, risky assumptions, and missing confirmations
- pod `openclaw-6-pod`
...
2. まず `exec` で `python3 /home/node/.openclaw/mattermost-tools/mattermost_get_state.py --instance 6` を実行し、今の Mattermost 状態を確認する。
